...
#include "../user/Bsp/Inc/bsp_can.h"
#include "../user/Module/imu_fusion.h"
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_WS2812_GPIO_Port, LED_WS2812_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : BMI088_ACCEL_CS_Pin LED_WS2812_Pin */
  GPIO_InitStruct.Pin = BMI088_ACCEL_CS_Pin|LED_WS2812_Pin;
